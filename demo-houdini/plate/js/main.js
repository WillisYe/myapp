/**
 *
 * @authors cydz (caiys@ycwb.com.cn)
 * @date    2023-10-13
 * @version $Id$
 */
 var swiper;
 ...
 $(function() {
     ...
     $(document).on('click','.sfimg', function(event) {
      ...
      $(document).on('click','.sht .btnq1,.sht .sjx1', function(event) {
        ...
        //alert(sdr)
        $(this).parent().find('.prat2content').height(sdr+80)
          $(this).parent().siblings().find('.sjx1').removeClass('jsx2');
          $('.sht').eq(0).find('.btnq1').attr('src','images/btn1.png?t=4');
          $('.sht').eq(1).find('.btnq1').attr('src','images/btn2.png?t=4');
          $('.sht').eq(2).find('.btnq1').attr('src','images/btn3.png?t=5');
          var indexx=$(this).parent().index();
         
          $('.sht').eq(indexx).find('.btnq1').attr('src','images/btn'+(indexx+1)+'on.png?t=6');
          $(this).parent().siblings().find('.sjx1').removeClass('jsx2');
